...
3. Keep typing to refine the match, or step between the matches with ↑ and ↓ while the search is showing. Pressing the same single letter again also cycles through the items that start with it.
