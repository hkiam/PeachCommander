...
<!-- BEGIN latest-release (generated by docs/scripts/gen-whats-new.py) -->
<div class="pc-whatsnew" markdown="1">
<p class="pc-whatsnew__eyebrow">New in 0.9.3 · 25 September 2026</p>
<p class="pc-whatsnew__lead">Markdown and HTML as PDFs, from the renderer that already draws them — and the five ways an SFTP site could be left unable to log in at all.</p>
<p class="pc-whatsnew__go"><a href="whats-new.html">What changed in every release &rarr;</a></p>
</div>
<!-- END latest-release -->
