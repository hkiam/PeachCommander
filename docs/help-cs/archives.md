...
- Archivy ZIP64 se otevírají jako každé jiné, archiv s více než 65 535 položkami nebo nad 4 GB tedy lze normálně prohlížet; výše uvedený limit na jeden rozbalený soubor platí dál.
