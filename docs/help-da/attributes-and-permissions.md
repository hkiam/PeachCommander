...
- Kommentarer med **linjeskift** og kommentarer i **UTF-16** læses og skrives, som Total Commander gør det: et linjeskift står som `\n` efterfulgt af de to markørbytes, TC fik registreret til formålet, og en fil, der var UTF-16, bliver UTF-16, når du ændrer én kommentar i den. Uden den markør er et `\n` i nogens kommentar to tegn, de har tastet, og de bliver rørt.
