...
- Tastaturet er det samme i alle tilstande: skriv for at springe til en fil, Ctrl+S filtrerer, mellemrum eller Insert markerer — og en markeret fil vises i markeringsfarven også i gitrene. Kun piletasterne er anderledes, for der flytter de sig celle for celle: inden for en kolonne i Kort visning, hen over gitteret i Ikoner og Galleri.
