...
- Die Inhaltssuche liest bei lokalen Ordnern ganze Dateien; an anderen Orten werden sehr große Dateien übersprungen (etwa 16 MB, oder 64 MB bei Verwendung eines regulären Ausdrucks).
