...
- Los comentarios con **saltos de línea** y los que están en **UTF-16** se leen y se escriben como lo hace Total Commander: un salto de línea se guarda como `\n` seguido de los dos bytes de marca que TC registró para ello, y un archivo que era UTF-16 sigue siendo UTF-16 cuando edita un comentario dentro. Sin esa marca, un `\n` en el comentario de alguien son dos caracteres que escribió, y se dejan tal cual.
