...
3. Active **Buscar dentro de archivos comprimidos** para mirar dentro de los que encuentre la búsqueda: los mismos formatos que puede abrir con Intro, incluidos los que añada un complemento de compresión. Los que no se hayan podido abrir se indican al terminar la búsqueda.
...
- La búsqueda de contenido lee los archivos completos en carpetas locales y dentro de archivos comprimidos; en ubicaciones de red los archivos muy grandes se leen solo en parte (unos 16 MB, o 64 MB al usar una expresión regular).
