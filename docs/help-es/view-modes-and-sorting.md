...
- El teclado es el mismo en todos los modos: escribe para saltar a un archivo, Ctrl+S filtra, Espacio o Insert marca — y un archivo marcado se muestra con el color de marcado también en las rejillas. Solo las flechas cambian, porque allí se mueven por celdas: dentro de una columna en la vista Breve, por la rejilla en Iconos y Galería.
