...
- Le clavier est le même dans tous les modes : la saisie saute à un fichier, Ctrl+S filtre, Espace ou Inser marque — et un fichier marqué apparaît aussi dans la couleur de marquage dans les grilles. Seules les flèches diffèrent, car elles s'y déplacent de cellule en cellule : dans une colonne en vue Bref, à travers la grille en Icônes et Galerie.
