...
- A megjegyzések egy `descript.ion` fájlban tárolódnak az elemek mellett, és a beállításaitól függően Finder-megjegyzésként is megőrizhetők. Egy megjegyzés megjelenítésekor a program mindkettőt beolvassa. A formátum ugyanaz, amit a Total Commander és több más fájlkezelő használ, így az itt írt megjegyzés ott is olvasható.
- A **sortöréseket** tartalmazó megjegyzések és az **UTF-16** kódolású megjegyzések úgy olvashatók és írhatók, ahogy a Total Commander teszi: a sortörés `\n` alakban tárolódik, utána a két jelölőbájt, amelyet a TC erre bejegyeztetett, és egy UTF-16 kódolású fájl UTF-16 marad, amikor egy megjegyzést módosít benne. E jelölés nélkül a `\n` valaki más megjegyzésében két begépelt karakter, és érintetlen marad.
- **A megjegyzés követi a fájlt.** A másolás, az áthelyezés és az átnevezés magával viszi — áthelyezéskor és másoláskor a célmappa `descript.ion` fájljába, átnevezéskor az új névre, akkor is, ha az átnevezést visszavonja. Kivétel az egyik fájl másik végéhez fűzése: a megmaradó fájl megtartja a saját megjegyzését, mert továbbra is ugyanaz a fájl.
- Ha a Jegyzetek bővítmény be van kapcsolva, az oldalsávja ugyanezt a megjegyzést jeleníti meg és szerkeszti a jegyzet szövege felett, hogy ne legyen két hely ugyanarra.
