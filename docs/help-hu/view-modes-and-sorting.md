...
- A billentyűzet minden módban ugyanaz: gépeléssel egy fájlra ugorhat, a Ctrl+S szűr, a szóköz vagy az Insert megjelöl — és a megjelölt fájl a rácsokban is a megjelölés színével látszik. Csak a nyilak mások, mert ott cellánként mozognak: a Rövid nézetben egy hasábon belül, az Ikonok és a Galéria nézetben a rácson át.
