...
- **På panelbakgrunnen** – Søk etter betydning, Organiser denne mappen og Finn sannsynlige duplikater.

**Oppsummer**, **Forklar**, **Foreslå et navn**, **Foreslå en kommentar** og **Organiser denne mappen** kommer fra utvidelsen **AI On-Device** og gjør jobben helt uten chat: de viser forslaget sitt i et ark, du fjerner haken ved det du vil la være, og ingenting på disken endres før du godkjenner det. De øvrige handlingene hører til utvidelsen **AI Assistant** og åpner sin egen navngitte chat, slik at ulike oppgaver holdes atskilt. Når du selv skriver i inndatafeltet, fortsetter forespørselen den gjeldende chatten.
...
- **Foretrukket modell** – hvilken modell chatten **AI Assistant** bruker. Etter at handlingene på enheten ble sin egen utvidelse, gjelder dette bare chatten: *Sky* og *Automatisk* bruker begge endepunktet nedenfor, og *På enheten* sier til chatten at den ikke trengs.
