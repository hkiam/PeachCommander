...
- Tastaturet er det samme i alle modus: skriv for å hoppe til en fil, Ctrl+S filtrerer, mellomrom eller Insert markerer — og en markert fil vises i markeringsfargen også i rutenettene. Bare pilene er annerledes, for der flytter de seg celle for celle: innenfor en kolonne i Kort visning, over rutenettet i Ikoner og Galleri.
