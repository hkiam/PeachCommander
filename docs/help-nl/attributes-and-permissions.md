...
- Opmerkingen worden opgeslagen in een `descript.ion`-bestand naast je items en kunnen, afhankelijk van je instellingen, ook als Finder-opmerkingen worden bewaard. Beide worden gelezen bij het weergeven van een opmerking. Het formaat is hetzelfde dat Total Commander en verschillende andere bestandsbeheerders gebruiken, dus een hier geschreven commentaar is daar leesbaar.
- Commentaar met **regeleinden** en commentaar in **UTF-16** wordt gelezen en geschreven zoals Total Commander het doet: een regeleinde staat als `\n` gevolgd door de twee markeringsbytes die TC daarvoor heeft laten registreren, en een bestand dat UTF-16 was blijft UTF-16 wanneer je er één commentaar in wijzigt. Zonder die markering is een `\n` in iemands commentaar twee getypte tekens, en die blijven onaangeroerd.
- **Een commentaar volgt het bestand.** Kopiëren, verplaatsen of hernoemen neemt het mee — naar de `descript.ion` van de doelmap bij verplaatsen en kopiëren, en naar de nieuwe naam bij hernoemen, ook wanneer je dat hernoemen ongedaan maakt. De uitzondering is het toevoegen van een bestand achter een ander: het bestand dat blijft houdt zijn eigen commentaar, want het blijft dat bestand.
- Staat de Notities-plug-in aan, dan toont en bewerkt de zijbalk hetzelfde commentaar boven de tekst van de notitie, zodat er niet twee plekken voor hetzelfde zijn.
