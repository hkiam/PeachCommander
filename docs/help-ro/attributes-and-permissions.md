...
- Comentariile cu **întreruperi de rând** și cele în **UTF-16** sunt citite și scrise așa cum o face Total Commander: o întrerupere de rând este stocată ca `\n` urmat de cei doi octeți de marcare pe care TC i-a înregistrat pentru asta, iar un fișier care era UTF-16 rămâne UTF-16 când modificați un comentariu din el. Fără acel marcaj, un `\n` din comentariul altcuiva înseamnă două caractere pe care le-a tastat și rămâne neatins.
