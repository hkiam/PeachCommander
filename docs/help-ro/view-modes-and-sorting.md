...
- Tastatura este aceeași în orice mod: tastarea sare la un fișier, Ctrl+S filtrează, Spațiu sau Insert marchează — iar un fișier marcat apare în culoarea de marcare și în grile. Diferă doar săgețile, pentru că acolo se mișcă din celulă în celulă: în cadrul unei coloane în vizualizarea Scurtă, de-a lungul grilei în Pictograme și Galerie.
