...
- **Полоса дисков**: по одной кнопке на каждый доступный диск или том, каждая с элементом извлечения и указанием свободного места. Щёлкните том, чтобы переключить на него эту панель.
...
*(Рис.: Полоса дисков — по одной кнопке на том, с элементом извлечения и оставшимся свободным местом.)*
