...
- Komentáre sú uložené v súbore `descript.ion` vedľa vašich položiek a možno ich tiež uchovať ako komentáre Finder, v závislosti od vašich nastavení. Oba sa čítajú pri zobrazení komentára.
