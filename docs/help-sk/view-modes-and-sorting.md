...
- Klávesnica funguje v každom režime rovnako: písaním skočíte na súbor, Ctrl+S filtruje, medzerník alebo Insert označuje — a označený súbor sa zobrazuje označovacou farbou aj v mriežkach. Líšia sa len šípky, pretože tam sa pohybujú po bunkách: v Krátkom zobrazení v rámci stĺpca, v Ikonách a Galérii po mriežke.
