...
- Komentarji s **prelomi vrstic** in komentarji v **UTF-16** se berejo in zapisujejo tako, kot to počne Total Commander: prelom vrstice je shranjen kot `\n`, ki mu sledita dva označevalna bajta, ki jih je TC dal registrirati za to, in datoteka, ki je bila UTF-16, ostane UTF-16, ko v njej spremenite en komentar. Brez te oznake je `\n` v komentarju nekoga drugega dva natipkana znaka in ostane nedotaknjen.
