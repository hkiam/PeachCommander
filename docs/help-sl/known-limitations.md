...
- **Zelo dolge poti delujejo, razen Koša.** macOS kot argument klica zavrne vsako pot, daljšo od 1024 bajtov, in tako globoko vgnezdene mape se pojavljajo. Brskanje, odpiranje, kopiranje, premikanje, preimenovanje, ustvarjanje in trajno brisanje jih dosežejo vse. Edina izjema je **premik v Koš**: macOS ne ponuja načina, da bi zavrgel datoteko, ki je ne more poimenovati, zato Delete tam javi napako — Shift+Delete (trajno izbriši) deluje.
