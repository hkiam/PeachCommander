...
- Tipkovnica je v vseh načinih enaka: tipkanje skoči na datoteko, Ctrl+S filtrira, preslednica ali Insert označi — označena datoteka pa se tudi v mrežah prikaže v barvi oznake. Razlikujejo se le puščice, ker se tam premikajo po celicah: v Kratkem pogledu znotraj stolpca, v Ikonah in Galeriji po mreži.
