...
- Tangentbordet är detsamma i alla läge: skriv för att hoppa till en fil, Ctrl+S filtrerar, blanksteg eller Insert markerar — och en markerad fil visas i markeringsfärgen även i rutnäten. Bara piltangenterna skiljer sig, för där flyttar de sig cell för cell: inom en kolumn i Kort vy, över rutnätet i Ikoner och Galleri.
