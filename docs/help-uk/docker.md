...
Віддалених рушіїв через SSH або TLS, запуску та зупинки контейнерів, журналів контейнера як файлу, інтерактивної оболонки та образів як файлових систем лише для читання.
